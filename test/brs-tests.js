		...
		describe("Don't add API path", () => {
			...
			it('IPv6:8123', async () => {
				const data = await brs.normalizeAPI(
					'[2001:19f0:4400:432c:5400:1ff:fe35:2641]:8123',
					true
				);
		...
		describe('Add API path', () => {
			...
			it('IPv6', async () => {
				...
				expect(data).to.equal(
					'[2001:19f0:4400:432c:5400:1ff:fe35:2641]:8123/burst?requestType='
				);
			});
		});
		describe('No Ports', () => {
			...
			it('IPv6', async () => {
				...
				expect(data).to.equal(
					'[2001:19f0:4400:432c:5400:1ff:fe35:2641]:8125/burst?requestType='
				);
			});
		});
